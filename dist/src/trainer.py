...
def train_from_created(
    *,
    ...
    local_prompts_dir: str | Path = "dist/output/prompts",
) -> dict:
...
def main() -> int:
    ...
    parser.add_argument("target", nargs="?", default="", help="Suno song URL, profile (@wren), or 'created'")
    parser.add_argument("--catalog", default="dist/models/suno_song_catalog.json", help="Path to catalog JSON")
    parser.add_argument("--inference", default="dist/models/suno_song_inference_model.json", help="Path to inference model JSON")
    parser.add_argument("--audio-dir", default="dist/output/audio", help="Directory to save downloaded audio")
    parser.add_argument("--transcripts-dir", default="dist/output/transcripts", help="Directory to save transcripts")
    ...
    if not target:
        print("Usage: python -m src.trainer <suno_url|@wren|created>")
        return 1
