# Studio Production Brief: Midnight Protocol

**Genre & Style**: `dark glam electropop`  
**BPM**: `122` | **Vocal Gender**: `F` | **Model Target**: `Suno V6`  
**Payload Lengths**: `3K JSON: 2,995 chars` | `5K JSON: 4,968 chars`
...
## 🎨 Cover Art Prompt
> **Album cover for song 'Midnight Protocol', aesthetic of dark glam electropop. Hyper-detailed portrait of a confident female pop star in a dark neon-lit studio booth, subtle velvet shadows, film grain, atmospheric smoke, cyan and magenta backlight, expensive high-fashion styling, shot on Hasselblad H6D-100c, 8k resolution, minimalist modern typography layout.**
