...
:run_trainer
"%PYTHON_EXE%" -m src.trainer %SONG_URL% --catalog models/suno_song_catalog.json --inference models/suno_song_inference_model.json --audio-dir output/audio --transcripts-dir output/transcripts
