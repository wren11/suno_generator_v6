...
//#region node_modules/.nitro/vite/services/ssr/assets/router-fI3E7ogk.js
...
function Toaster$1() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toaster, {
		...
		toastOptions: { classNames: {
			toast: "bg-card text-foreground shadow-[var(--shadow-soft)] border-0",
...
var styles_default = "/assets/styles-DDjR48XL.css";
var APP_NAME = "Scansion";
var Route$2 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Suno lyric architect. Meter, rhyme, and hit DNA — paste-ready Custom Mode prompts."
			}
		],
		links: [
			{
			...
			{
				rel: "stylesheet",
				href: "https://fonts.googleapis.com/css2?family=Figtree:ital,wght@0,400;0,500;0,600;0,700;1,400&family=Fraunces:ital,opsz,wght@0,9..144,500;0,9..144,600;0,9..144,700;1,9..144,500;1,9..144,600&family=IBM+Plex+Mono:wght@400;500&display=swap"
			}
		]
	}),
...
var $$splitComponentImporter$1 = () => import("./routes-BKJSROU_.mjs");
var Route$1 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./foundry-BGG_ZdcH.mjs");
var Route = createFileRoute("/foundry")({ component: lazyRouteComponent($$splitComponentImporter, "component") });
